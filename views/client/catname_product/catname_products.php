<div class="container">
    <div class="container py-5">
        <h2 class="mb-4 fw-bold"><?= htmlspecialchars($title ?? 'Sản phẩm') ?></h2>

        <div class="row mb-4">
            <div class="col-md-12">
                <form method="get" class="row g-2 align-items-end">
                    <input type="hidden" name="action" value="<?= htmlspecialchars($actionName ?? '') ?>">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
        <?php if (!empty($allProducts)): foreach ($allProducts as $pro): ?>
            <div class="col">
